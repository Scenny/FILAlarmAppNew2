...
public class AlarmKlaxon extends Service {
    ...
    private void play(Alarm alarm) {
        ...
        if (!alarm.silent) {
            ...
            Uri alert = null;
            Log.i("pyf", info.music);
            if (info.music != null && info.music != "") {
				alert = Uri.parse(info.music);
			}
    ...
    private void startAlarm(MediaPlayer player)
        ...
        if (audioManager.getStreamVolume(AudioManager.STREAM_ALARM) != 0) {
            ...
            player.setOnPreparedListener(new MediaPlayListener()); 
            player.prepare();
        }
    }
    
    private class MediaPlayListener implements MediaPlayer.OnPreparedListener{
